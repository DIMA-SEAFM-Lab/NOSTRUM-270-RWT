------- OpenFAST INPUT FILE ------------------------------------------- 
NOSTRUM 15 MW offshore reference model on UMaine VolturnUS-S semi-submersible floating platform
---------------------- SIMULATION CONTROL -------------------------------------- 
...
---------------------- INPUT FILES --------------------------------------------- 
"NOSTRUM-15-270-RWT-UMaineSemi-Elastodyn.dat"                                  EDFile          - Name of file containing ElastoDyn input parameters (quoted string) 
...
"inflow_11mps.dat"                                     InflowFile      - Name of file containing inflow wind input parameters (quoted string) 
"NOSTRUM-15-270-RWT-UMaineSemi_AeroDyn15.dat"        AeroFile        - Name of file containing aerodynamic input parameters (quoted string) 
"NOSTRUM-15-270-RWT-UMaineSemi_ServoDyn.dat"         ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string) 
"NOSTRUM-15-270-RWT-UMaineSemi_SeaState.dat"         SeaStFile       - Name of file containing sea state input parameters (quoted string)
"NOSTRUM-15-270-RWT-UMaineSemi_HydroDyn.dat"         HydroFile       - Name of file containing hydrodynamic input parameters (quoted string) 
"none"                                                  SubFile         - Name of file containing sub-structural input parameters (quoted string) 
"NOSTRUM-15-270-RWT-UMaineSemi_MoorDyn.dat"          MooringFile     - Name of file containing mooring system input parameters (quoted string) 
